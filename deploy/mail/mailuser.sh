#!/usr/bin/env bash
# Manage robustuavs.ai mailboxes without hand-writing docker commands.
#
...
#
# <user> may be "sarah" or "sarah@robustuavs.ai" — the domain is added
...
# "oger@d|" is a substring of "roger@d|" and would give the wrong answer.
exists() {
  [[ -f $ACCOUNTS_FILE ]] &&
